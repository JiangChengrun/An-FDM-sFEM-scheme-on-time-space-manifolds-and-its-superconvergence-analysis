function mesh = torusRegularMesh(Nu, Nv, R, r)
%% TORUSUNIFORMMESH Generate regular pattern mesh on torus
%   [NODE,ELEM] = TORUSUNIFORMMESH(NU, NV, R, R) return the mesh data of
%   regular pattern mesh on torus
%
...
mesh = struct('node', node, 'elem', elem, 'point', point);
