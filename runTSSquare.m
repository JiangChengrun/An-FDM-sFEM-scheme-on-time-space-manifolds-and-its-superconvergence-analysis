...
for k=1:maxIt
    ...
    [l2err(k), h1err(k), h1terr(k), h1rerr(k), h00terr(k), h00rerr(k),h00rerr2(k)] = TSError(mesh, u, pde);
    disp(l0err(k));
    % Refine mesh
    Nd = Nd*2;
    %nt = nt*2;
...
% triangle([N(3),h1err(3).*1.5],N(4),-0.5,'1','0.5',1.3);
...
error = table(N, l2err, order_l2err, h1err, order_h1err, h1terr, order_h1terr, h1rerr, order_h1rerr, h00terr, order_h00terr, h00rerr, order_h00rerr);
writetable(error, 'C:/Users/13393/Desktop/Code/TS_original/results/SquareErrors.xlsx')
disp(error);
